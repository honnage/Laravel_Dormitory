                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 my-2">
                         ...
                         <div class="form-group col-xs-12 col-sm-12 col-md-12 my-2">
                            ...
                            <input type="text" class="form-control col-sm-3" name="bill_unitselEctricity" id="bill_unitselEctricity" style="color: blue; font-size: 20px" value="{{ $customer->rooms_unitsElectricity }}" readonly>
